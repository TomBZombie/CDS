...
ul li span {
  ...
  },
  {
    ...
    public function testTemplateSelector()
    {
        ...
        $this->assertEquals(
            $this->stripTabs('<div><div class="test1"><a>Test1</a><a>Test2</a></div></div>'),
    ...
    public function testTemplateSelectorWithAsterisk()
    {
        ...
        $this->assertEquals(
            $this->stripTabs('<div><a>Test1</a><a>Test2</a></div>'),
            $this->stripTabs($template->output()->body)
        );
    }
    ...
    public function testRuleWithNewline()
    {
        ...
        $this->assertEquals(
            $this->stripTabs('<p>http://foo/bar</p>'),
            $this->stripTabs($template->output()->body)
        );
    }
   ...
   /*.comment {foo: bar} */
	...
	';
        ...
        $this->assertEquals(
            $this->stripTabs('<div>foo</div><span>bar</span>'),
            $this->stripTabs($template->output()->body)
        );
    }
    ...
    public function testNotWellFormedPartialBefore()
    {
        ...
        $this->assertEquals(
            $this->stripTabs('<body><header>foo</header>
    ...
    public function testConcatDataAndAttr()
    {
        ...
        $this->assertEquals(
            $this->stripTabs('<h1 class="foo AFTER">Example Title</h1>'),
    ...
    public function testAttrBefore()
    {
        ...
        $this->assertEquals(
            $this->stripTabs('<h1 class="BEFORE foo">Example Title</h1>'),
            $this->stripTabs($template->output($data)->body)
        );
    }
